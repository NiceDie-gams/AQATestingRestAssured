...
public class DeliveryCodeTest { //Инденпотентность разобраться!!!
    ...
    public void checkDeliveryCode(String kladrCode, String cdekCode){
        ...
        */
        ...
        System.out.println("Test A running in thread: " + Thread.currentThread().getName());
    ...
    public void checkDeliveryCodeForIncorrectKladr(String kladr, String cdek) {
        ...
        */
        ...
        System.out.println("Test B running in thread: " + Thread.currentThread().getName());
    ...
    public void queryImportanceTest(){
        ...
        */
        ...
        System.out.println("Test C running in thread: " + Thread.currentThread().getName());
    ...
    public void authorizationKeyImportanceTest(String kladrCode){
        ...
        */
        ...
        System.out.println("Test D running in thread: " + Thread.currentThread().getName());
